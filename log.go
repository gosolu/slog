...
// Bind context with some fields
func Bind(ctx context.Context, fields ...Field) context.Context {
	return BindLogger(ctx, gLogger, fields...)
}

// BindLogger bind logger with fields and embed into context
func BindLogger(ctx context.Context, logger *Logger, fields ...Field) context.Context {
	if len(fields) < 1 {
		return ctx
	}
